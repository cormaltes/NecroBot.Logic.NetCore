    ...
    public class AuthSettings
    {
        ...
        public void Load(string path)
        {
            try
            {
                ...
                if (!this.DeviceConfig.DevicePackageName.Equals("random", StringComparison.OrdinalIgnoreCase) && !this.DeviceConfig.DevicePackageName.Equals("custom", StringComparison.OrdinalIgnoreCase))
                {
                ...
                if (this.DeviceConfig.DevicePackageName.Equals("random", StringComparison.OrdinalIgnoreCase))
                {
        ...
        private WebProxy InitProxy()
        {
            ...
            var prox = new WebProxy(ProxyConfig.UseProxyHost, ProxyConfig.UseProxyPort);
